...
(()=>{
  ...
  C.elementMultiplier=(enemy,element)=>{const e=element||'physical';if((enemy.absorb||[]).includes(e))return -1;if((enemy.immune||[]).includes(e))return 0;if((enemy.weaknesses||[enemy.weak]).includes(e))return 1.5;if((enemy.resistances||[]).includes(e))return .55;return 1};
