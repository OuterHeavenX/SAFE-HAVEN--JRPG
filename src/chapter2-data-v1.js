...
(()=>{
  ...
  if(SH.Classic?.abilities){Object.assign(SH.Classic.abilities,{
    quickStep:{id:'quickStep',name:'Quick Step',discipline:'wanderer',jpCost:135,type:'skill',targetType:'self',description:'Sharpen your rhythm and accelerate the next ATB cycle.',prerequisites:['focus'],requiredRank:5},
    bladeRush:{id:'bladeRush',name:'Blade Rush',discipline:'warrior',jpCost:190,type:'skill',power:1.75,element:'physical',targetType:'enemy',description:'A fast, punishing sword combination.',prerequisites:['powerStrike'],requiredRank:7},
    blizzara:{id:'blizzara',name:'Blizzara',discipline:'blackMage',jpCost:145,mpCost:10,type:'magic',power:82,element:'ice',targetType:'enemy',description:'Deal stronger Ice damage to one enemy.',prerequisites:['blizzard'],requiredRank:6,animationKey:'ice'},
    thundara:{id:'thundara',name:'Thundara',discipline:'blackMage',jpCost:165,mpCost:11,type:'magic',power:88,element:'lightning',targetType:'enemy',description:'Deal stronger Lightning damage to one enemy.',prerequisites:['thunder'],requiredRank:7,animationKey:'lightning'},
    regen:{id:'regen',name:'Regen',discipline:'whiteMage',jpCost:170,mpCost:8,type:'magic',power:0,element:'holy',targetType:'ally',description:'Wrap an ally in restorative light.',prerequisites:['cure'],requiredRank:6,animationKey:'cure'}
  })}
})();