...
(()=>{
  ...
  SH.Battle=class extends Base{
    constructor(game,enemyIds){
      super(game,enemyIds);
      this.atbReady=false;this.playerATB=0;this.turn='wait';this.phase='charging';this.message='ATB gauges are charging...';this._atbLast=performance.now();this._atbEnemyLock=false;
