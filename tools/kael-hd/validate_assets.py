...
for name, anim in data["animations"].items():
    ...
    user_authored = anim.get("source") == "user-authored"
    ...
    for i in range(count):
        ...
        if not user_authored and any(a and g > 35 and g > r * 1.15 and g > b * 1.18 for r, g, b, a in im.get_flattened_data()):
        ...
        if not user_authored and bbox[3] != fh - 2: errors.append(f"{name}[{i}]: baseline {bbox[3]}, expected {fh-2}")
